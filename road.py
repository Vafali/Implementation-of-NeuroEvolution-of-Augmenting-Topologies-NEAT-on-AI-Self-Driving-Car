...
class Road:
    def __init__(self, world):
        ...
        for i in range(NUM_POINTS*self.num_ctrl_points):        #fill the points Left and point Right vectors
    ...
    def createSegment(self, index):
        ...
        ny = np.array([p2.y, p1.y]) #inverted because scify wants increasing x's (in this case y's)
