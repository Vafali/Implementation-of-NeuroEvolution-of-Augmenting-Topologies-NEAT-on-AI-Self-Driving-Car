...
def draw_win(cars, road, world, GEN):     #x and y are the coordinates of the best car
    road.draw(world)
    for car in cars:
        car.draw(world)
    ...
    py.display.update()
    world.win.blit(bg, (0,0))       #blit the background immediately after the update so if I have draws before the draw_win they are not covered by the background
